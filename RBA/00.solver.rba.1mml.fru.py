...
#change medium
model.medium["M_fru"]=10
model.medium["M_c160"]=0
...
set_flux_boundary(model, 'R_EX_eth_e', 0.0)
set_flux_boundary(model, 'R_EX_ac_e', 0.0)

set_flux_boundary(model, 'R_EX_fru_e', float(2.67))
#set_flux_boundary(model, 'R_FRUP', float(2.67))
#R_EX_o2_e O2
